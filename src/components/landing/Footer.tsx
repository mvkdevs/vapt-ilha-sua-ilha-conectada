    ...
    <footer className="py-16 bg-foreground">
       <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          {/* Contact */}
          <div className="flex flex-col items-center md:items-start gap-4">
            <h4 className="text-background font-display font-bold text-lg">Contato</h4>
          ...
          {/* Social Media */}
          <div className="flex flex-col items-center md:items-start gap-4">
            <h4 className="text-background font-display font-bold text-lg">Redes Sociais</h4>
            <div className="flex gap-4">
              <a 
                href="https://instagram.com/vaptilha" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-background/10 flex items-center justify-center hover:bg-secondary hover:text-primary transition-colors text-background/80"
              >
